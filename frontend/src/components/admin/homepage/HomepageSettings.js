...
import { setHomepageSettings } from "../../../services/AdminServices";
import { getHomepageSettings } from "../../../services/BaseServices";
...
export const HomepageSettings = () => {
  ...
  const saveSettings = () => {
    ...
    setHomepageSettings(formatted_settings)
      .then((response) => {
      ...
      <div>
        ...
        <div className="big-input">
          <FormControlLabel
            ...
            label="Show Argyle button"
            labelPlacement="start"
          ></FormControlLabel>
          {settings.show_button && (
            <div className="margin-bottom-25 big-input">
              <TextField
                id="button_text"
                name="button_text"
                label="Button Text"
          ...
          <Button
            color="primary"
            variant="contained"
            className="homePageSaveButton spinner-container"
